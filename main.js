...
var groups = [{"group": "A", "teams": ["brazil","mexico"], "finished" : true }, {"group": "B", "teams": ["holland","chile"], "finished" : true }, {"group": "C", "teams": ["colombia","greece"], "finished" : true }, {"group": "D", "teams": ["costarica","uruguay"], "finished" : true }, {"group": "E", "teams": ["france","ecuador","switzerland","honduras"], "finished" : false }, {"group": "F", "teams": ["argentina","nigeria","iran"], "finished" : false }, {"group": "G", "teams": ["germany","usa", "ghana", "portugal"], "finished" : false }, {"group": "H", "teams": ["belgium","algeria","russia","southkorea" ], "finished" : false } ]; 
var favorite = "";
var scenario;
var selectedCountry;
